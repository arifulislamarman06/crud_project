          ...
          <div class="col-lg-10 m-auto">
            ...
            <?php
              ...
              if (isset($_POST['submit'])) {
                ...
                // $insert = "INSERT INTO `register`(`name`, `degree`, `mobile`, `email`, `refer`, `jobpost`) VALUES ('$name ','$qualification','$email','$mobile','$reference','$post')";

                $update = "UPDATE `register` SET `id`='$idupdate',`name`='$name',`degree`='$degree',`mobile`='$mobile',`email`='$email',`refer`='$refer',`jobpost`='$jobpost' WHERE id=$idupdate";
